...
import { Package, Lock, Mail, Building2, Loader2, ArrowRight, ShieldCheck, CheckCircle2 } from 'lucide-react';
                ...
                {stepsInfo.map((s, i) => (
                    <React.Fragment key={s.key}>
                        <div className="flex flex-col items-center gap-1">
                            <div className={`w-8 h-8 rounded-full flex items-center justify-center text-xs font-black transition-all duration-300 ${i < currentIdx ? 'bg-success text-white' : i === currentIdx ? 'bg-accent text-white shadow-lg shadow-accent/30' : 'bg-surface-muted text-text-muted'
                                }`}>
