        ...
        <div className="relative" ref={containerRef}>
            ...
            >
                ...
                <div className="flex flex-col items-start leading-none gap-1 ">
                    <span className="text-[10px] font-black uppercase tracking-widest text-text-muted opacity-60 hidden md:block">Language</span>
                    <div className="flex items-center gap-1">
                        <span className="text-sm font-black uppercase tracking-tight hidden md:block">{currentLanguage.label}</span>
                        <span className="text-sm font-black uppercase tracking-tight md:hidden">{currentLanguage.code}</span>
