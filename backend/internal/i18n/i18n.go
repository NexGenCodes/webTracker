...
var Translations = map[Language]map[string]string{
	EN: {
		...
		"MSG_INFO_INCOMPLETE":  "⚠️ *Manifest Incomplete*\n\n_We could not process this manifest because the following required fields are missing:_\n\n%s\n\n💡 _Tip: Please double-check your manifest format and resubmit._",
	...
	PT: {
		...
		"MSG_INFO_INCOMPLETE":  "⚠️ *Manifesto Incompleto*\n\n_Não pudemos processar este manifesto porque os seguintes campos obrigatórios estão ausentes:_\n\n%s\n\n💡 _Dica: Por favor, verifique o formato do seu manifesto e reenvie._",
	...
	ES: {
		...
		"MSG_INFO_INCOMPLETE":  "⚠️ *Manifiesto Incompleto*\n\n_No pudimos procesar este manifiesto porque faltan los siguientes campos obligatorios:_\n\n%s\n\n💡 _Consejo: Por favor, verifique el formato de su manifiesto y vuelva a enviarlo._",
	...
	DE: {
		...
		"MSG_INFO_INCOMPLETE":  "⚠️ *Manifest Unvollständig*\n\n_Wir konnten dieses Manifest nicht verarbeiten, da die folgenden Pflichtfelder fehlen:_\n\n%s\n\n💡 _Tipp: Bitte überprüfen Sie das Format Ihres Manifests und reichen Sie es erneut ein._",
