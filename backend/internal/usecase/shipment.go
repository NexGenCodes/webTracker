...
func (u *ShipmentUsecase) Track(ctx context.Context, companyID uuid.UUID, trackingID string) (*db.Shipment, error) {
...
func (u *ShipmentUsecase) Create(ctx context.Context, companyID uuid.UUID, params db.CreateShipmentParams) error {
...
func (u *ShipmentUsecase) UpdateStatus(ctx context.Context, companyID uuid.UUID, trackingID, status, destination string) error {
...
func (u *ShipmentUsecase) ListPaginated(ctx context.Context, companyID uuid.UUID, limit, offset int32) ([]db.Shipment, error) {
...
func (u *ShipmentUsecase) Delete(ctx context.Context, companyID uuid.UUID, trackingID string) error {
...
func (u *ShipmentUsecase) DeleteDelivered(ctx context.Context, companyID uuid.UUID) error {
...
func (u *ShipmentUsecase) ProcessMaintenance(ctx context.Context, companyID uuid.UUID, now time.Time) (int, error) {
	totalTransitioned := 0
...
func (u *ShipmentUsecase) RunAgedCleanup(ctx context.Context, companyID uuid.UUID, deliveredOlderThan, createdOlderThan time.Time) (int64, error) {
...
func (u *ShipmentUsecase) CreateWithPrefix(ctx context.Context, companyID uuid.UUID, s *db.Shipment, prefix string) (string, error) {
	if prefix == "" {
		prefix = "AWB"
	}
...
func (u *ShipmentUsecase) FindSimilar(ctx context.Context, companyID uuid.UUID, userJID, phone string) (string, error) {
...
func (u *ShipmentUsecase) GetLastForUser(ctx context.Context, companyID uuid.UUID, userJID string) (string, error) {
...
func (u *ShipmentUsecase) UpdateField(ctx context.Context, companyID uuid.UUID, trackingID, field, value string) error {
	switch field {
	case "sender_name":
...
func (u *ShipmentUsecase) CountDailyStats(ctx context.Context, companyID uuid.UUID, since time.Time) (created int64, delivered int64, err error) {
...
func (u *ShipmentUsecase) ListAll(ctx context.Context, companyID uuid.UUID) ([]db.Shipment, error) {
...
func (u *ShipmentUsecase) ProcessTransitions(ctx context.Context, companyID uuid.UUID, now time.Time) ([]TransitionResult, error) {
...
func (u *ShipmentUsecase) CountAll(ctx context.Context, companyID uuid.UUID) (int64, error) {
	return u.repo.CountShipments(ctx, toNullUUID(companyID))
}

func (u *ShipmentUsecase) CountByStatus(ctx context.Context, companyID uuid.UUID) (*db.CountShipmentsByStatusRow, error) {
...
func (u *ShipmentUsecase) RecordEvent(ctx context.Context, companyID uuid.UUID, eventType string, metadata []byte) error {
...
func (u *ShipmentUsecase) GetTelemetryStats(ctx context.Context, companyID uuid.UUID, since time.Time) ([]db.GetTelemetryStatsRow, error) {
	return u.repo.GetTelemetryStats(ctx, db.GetTelemetryStatsParams{CompanyID: toNullUUID(companyID), CreatedAt: toNullTime(since)})
}

func (u *ShipmentUsecase) GetRecentEvents(ctx context.Context, companyID uuid.UUID, limit int32) ([]db.Telemetry, error) {
	return u.repo.GetRecentEvents(ctx, db.GetRecentEventsParams{CompanyID: toNullUUID(companyID), Limit: limit})
}

func (u *ShipmentUsecase) BulkUpdateStatus(ctx context.Context, companyID uuid.UUID, ids []string, status string) error {
